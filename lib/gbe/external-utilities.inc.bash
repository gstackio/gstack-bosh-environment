...
BOSH_CLI_ACCEPTED_VERSIONS='^6\..*'
SPRUCE_VERSION=1.22.0
SPRUCE_ACCEPTED_VERSIONS='^1\.22\..*'
CREDHUB_CLI_VERSION=2.6.0
CREDHUB_CLI_ACCEPTED_VERSIONS='^2\.6\..*'
DNSCONTROL_VERSION=2.9
DNSCONTROL_ACCEPTED_VERSIONS='^2\.9.*'
CF_CLI_VERSION=6.47.1
CF_CLI_ACCEPTED_VERSIONS='^6\.47\..*'
